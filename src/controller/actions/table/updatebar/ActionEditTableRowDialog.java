...
/**
 * Akcija koja se poziva kada se aktivira dugme za editovanje selektovanog reda. Dugme koje je pozvano
 * se nalazi na toolbar-u, vezano je za operacije nad tabelom.
 * 
 * @author Aleksandar
 */
public class ActionEditTableRowDialog extends AbstractActionPrototype {

	public ActionEditTableRowDialog(String title, String icon, String tooltip, String accelertor, int mnemonic) {
		super(title, icon, tooltip, accelertor, mnemonic);
		// TODO Auto-generated constructor stub
	}

	public ActionEditTableRowDialog(String title, String icon, String tooltip, String accelertor) {
		super(title, icon, tooltip, accelertor);
		// TODO Auto-generated constructor stub
	}

	public ActionEditTableRowDialog(String title, String icon, String tooltip) {
	...
	public void actionPerformed(ActionEvent e) {
		JButton btnEditRow = (JButton) e.getSource();
		JToolBar toolbar = (JToolBar) btnEditRow.getParent();
		...
		RowUpdateDialog ruf = new RowUpdateDialog(currentTableModel ,  TableUpdateMode.EDIT_ROW);
		ruf.setVisible(true);
	}
