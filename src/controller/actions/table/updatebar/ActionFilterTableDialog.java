...
public class ActionFilterTableDialog extends AbstractActionPrototype {

	public ActionFilterTableDialog(String title, String icon, String tooltip, String accelertor, int mnemonic) {
		super(title, icon, tooltip, accelertor, mnemonic);
		// TODO Auto-generated constructor stub
	}

	public ActionFilterTableDialog(String title, String icon, String tooltip, String accelertor) {
		super(title, icon, tooltip, accelertor);
		// TODO Auto-generated constructor stub
	}

	public ActionFilterTableDialog(String title, String icon, String tooltip) {
	...
	public void actionPerformed(ActionEvent e) {
		JButton btnFilter = (JButton) e.getSource();
		JToolBar toolbar = (JToolBar) btnFilter.getParent();
		...
		RowUpdateDialog ruf = new RowUpdateDialog(currentTableModel ,  TableUpdateMode.FILTER_TABLE);
		ruf.setVisible(true);
	}
